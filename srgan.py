...
class SRGAN():
    def __init__(self):
        ...
        print('self.build_vgg start')
        self.vgg = self.build_vgg()
        self.vgg.trainable = False
        self.vgg.compile(loss='mse',
            optimizer=optimizer,
            metrics=['accuracy'])
        print('self.build_vgg finish')
    ...
    def generate(self, batch_size=25, sample_interval=50):
        ...
        g.load_weights('./weights/generator_13000.h5')
        for i in range(20):
            ...
            image_noise.save("./images/noise_%s%d.jpg" % (ite,i))
            image = combine_images(generated_images)
            image.save("./images/%s%d.jpg" % (ite,i))
            print(i)
